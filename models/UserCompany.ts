// models/UserCompany.ts
import mongoose, { Schema, Document } from 'mongoose';

export interface IUserCompany extends Document {
  userId: mongoose.Types.ObjectId; // References your EXISTING User model
...
// 🔐 CRITICAL: Compound index for unique user-company relationship
UserCompanySchema.index({ userId: 1, companyId: 1 }, { unique: true });

// Index for finding users in a company
