// components/advance/analytics/CurrentSubscriptionCard.tsx
      ...
      <CardContent>
        ...
        <Box sx={{ 
          ...
          {[
            {
              label: 'Current Plan',
              value: currentSubscription.plan.charAt(0).toUpperCase() + currentSubscription.plan.slice(1),
            },
            {
              label: 'Next Billing',
              value: new Date(currentSubscription.currentPeriodEnd).toLocaleDateString(),
            },
            {
              label: 'Days Remaining',
              value: subscriptionMetrics.daysRemaining,
            },
            {
              label: 'Auto Renew',
