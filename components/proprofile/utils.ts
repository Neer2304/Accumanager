// components/proprofile/utils.ts
export const PRICING_PLANS: Record<string, unknown> = {
...
export const getPlanColor = (plan: string): string => {
  switch (plan) { case 'trial': return '#9aa0a6'; case 'monthly': return '#1a73e8'; case 'quarterly': return '#34a853'; case 'yearly': return '#fbbc04'; default: return '#9aa0a6'; }
};
