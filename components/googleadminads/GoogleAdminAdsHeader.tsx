// components/googleadminads/GoogleAdminAdsHeader.tsx
'use client'
...
interface GoogleAdminAdsHeaderProps {
  onAddClick: () => void
  darkMode?: boolean
  isMobile?: boolean
  isTablet?: boolean
...
export default function GoogleAdminAdsHeader({ 
  onAddClick, 
  darkMode, 
  isMobile, 
  isTablet 
}: GoogleAdminAdsHeaderProps) {
  return (
