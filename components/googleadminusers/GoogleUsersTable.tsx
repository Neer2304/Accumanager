// components/googleadminusers/GoogleUsersTable.tsx
...
interface GoogleUsersTableProps {
  users: User[];
  loading: boolean;
  currentPage: number;
  totalPages: number;
...
export const GoogleUsersTable = memo(function GoogleUsersTable({
  users,
  loading,
  currentPage,
  totalPages,
